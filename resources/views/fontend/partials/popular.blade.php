<section class="space-extra-top">
    <div class="container">
        <div class="title-area text-center">
            ...
            <h2 class="sec-title fw-medium">Watch Free Courses</h2>
        </div>
    </div>
    <div class="course-sec space-bottom">
        ...
        <div class="container">
            ...
            <div class="course-grid2">
                <div class="course-img">
                    <img src="{{asset('fontend/assets/img/update1/course/course_5_1.jpg')}}" alt="course">
                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn popup-video"><i class="fas fa-play"></i></a>
                </div>
                <div class="course-content">
                    <h3 class="course-title"><a href="course-details.html">How To Make Something Very Easier</a></h3>
            ...
            <div class="course-grid2">
                <div class="course-img">
                    <img src="{{asset('fontend/assets/img/update1/course/course_5_2.jpg')}}" alt="course">
                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn popup-video"><i class="fas fa-play"></i></a>
                </div>
                <div class="course-content">
        ...
        <div class="shape-mockup" data-bottom="0%" data-right="0%"><img src="{{asset('fontend/assets/img/update1/shape/line_5.png')}}" alt="shapes"></div>
    </div>
    <div class="shape-mockup jump" data-top="0%" data-left="0%"><img src="{{asset('fontend/assets/img/update1/shape/dot_shape_5.png')}}" alt="shapes"></div>
</section>