...
<body>
    <!--============================== Breadcumb ============================== -->
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('fontend/assets/img/bra.jpg') }}" data-overlay="title"
        data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">New Registation</h1>
            </div>
        </div>
    </div>
    <!--============================= OTP Area  ==============================-->
            ...
            <div class="row">
                <div class="col-4" style="margin: 0px auto !important;">
                    <div class="contact-form-wrap" data-bg-src="{{ asset('fontend/assets/img/bg/contact_bg_1.png') }}">
                        ...
                        <form method="POST" action="{{ route('examinee.register.store') }}" class="contact-form">
                            @csrf

                            @if (filter_var($identifier, FILTER_VALIDATE_EMAIL))
                                <small class="text-muted">Verified email: {{ $identifier }}</small>
                            @else
                                <small class="text-muted">Verified phone: {{ $identifier }}</small>
                            @endif
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input name="name" placeholder="Full name" value="{{ old('name') }}"
                                            class="form-control style-white" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input name="email" type="email" placeholder="Email (optional)"
                                            value="{{ filter_var($identifier, FILTER_VALIDATE_EMAIL) ? $identifier : old('email') }}"
                                            class="form-control style-white"
                                            {{ filter_var($identifier, FILTER_VALIDATE_EMAIL) ? 'readonly' : '' }}>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input name="phone" placeholder="Phone (optional)"
                                            value="{{ !filter_var($identifier, FILTER_VALIDATE_EMAIL) ? $identifier : old('phone') }}"
                                            class="form-control style-white"
                                            {{ !filter_var($identifier, FILTER_VALIDATE_EMAIL) ? 'readonly' : '' }}>
                                ...
                                <div class="form-btn col-12 mt-10">
                                    <button class="th-btn">Create account <i
