    ...
    <div class="breadcumb-wrapper " data-bg-src="{{asset('fontend/assets/img/bra.jpg')}}" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">Verify OTP</h1>
            </div>
        </div>
    </div>
    <!--============================= OTP Area  ==============================-->
            ...
            <div class="row">
                <div class="col-4" style="margin: 0px auto !important;">
                    <div class="contact-form-wrap" data-bg-src="{{asset('fontend/assets/img/bg/contact_bg_1.png')}}">
                        ...
                        <form method="POST" action="{{ route('otp.verify') }}" class="contact-form"> 
                          @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="hidden" name="identifier" value="{{ $identifier }}">
                                        <input name="code" placeholder="6-digit code" class="form-control style-white">
                                        <i class="fa-solid fa-laptop-code"></i>
                                        <div class="form-btn col-12 mt-10">
                                            <button class="th-btn">Verify OTP<i class="fas fa-long-arrow-right ms-2"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
