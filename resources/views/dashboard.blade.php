...
@section('title', 'Super Admin Dashboard')  {{-- Title section --}}
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title text-black mb-0">Monthly Overview</h5>
        ...
        <div class="row">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0 align-self-center">
                                        ...
                                        <div class="align-content-center text-center border border-dashed rounded-circle p-1">
                                            <img src="{{ asset('backend/assets/images/users/user-12.jpg') }}" class="avatar avatar-sm rounded-circle">
                                        </div>
                                        <!-- End Avatar -->
                                    </div>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title text-black mb-0">Premium User</h5>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-xl-3">
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title text-black mb-0">Examinee Area</h5>
                            <div class="ms-auto"> 
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title text-black mb-0">Ebook Reports</h5>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive table-card mt-0">
                                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                    <thead class="text-muted table-light">
                                        <tr>
                                            <th scope="col" class="cursor-pointer">Writer name</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ asset('backend/assets/images/users/user-12.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                                John Hamilton
                                            </td>
                                            ...
                                            <td>Mufti</td>
                                            <td>
                                                <span class="badge bg-primary-subtle text-primary fw-semibold">Math</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('backend/assets/images/users/user-11.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                                Janice Reese
                                            </td>
                                            ...
                                            <td>Gucci</td>
                                            <td>
                                                <span class="badge bg-primary-subtle text-primary fw-semibold">Bangla</span>
                                            </td>
                                            <td>
                                                <a aria-label="anchor" class="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                    <i class="mdi mdi-pencil-outline fs-16 text-muted"></i>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('backend/assets/images/users/user-13.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                                Andrew Kim
                                            </td>
                                            ...
                                            <td>Vans</td>
                                            <td>
                                                <span class="badge bg-primary-subtle text-primary fw-semibold">English</span>
                                            </td>
                                            <td>
                                                <a aria-label="anchor" class="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                    <i class="mdi mdi-pencil-outline fs-16 text-muted"></i>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('backend/assets/images/users/user-14.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                                Kathryn Sanchez
                                            </td>
                                            ...
                                            <td>Myntra</td>
                                            <td>
                                                <span class="badge bg-primary-subtle text-primary fw-semibold">General Knowledge</span>
                                            </td>
                                            <td>
                                                <a aria-label="anchor" class="me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                    <i class="mdi mdi-pencil-outline fs-16 text-muted"></i>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ asset('backend/assets/images/users/user-15.jpg') }}" class="avatar avatar-sm rounded-circle me-3">
                                                Diane Richards
                                            </td>
