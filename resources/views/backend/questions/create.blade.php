            ...
            <form method="POST" action="{{ route('questions.store') }}">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  <label>Ans 1</label>
                  <textarea name="answer_1" class="form-control" rows="5" required>{{ old('answer_1') }}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                  <label>Ans 2</label>
                  <textarea name="answer_2" class="form-control" rows="5" required>{{ old('answer_2') }}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                  <label>Ans 3</label>
                  <textarea name="answer_3" class="form-control" rows="5" required>{{ old('answer_3') }}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                  <label>Ans 4</label>
                  <textarea name="answer_4" class="form-control" rows="5" required>{{ old('answer_4') }}</textarea>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9 mb-3">
                  ...
                  <textarea name="explanation" class="form-control" rows="5">{{ old('explanation') }}</textarea>
                </div>
              </div>
