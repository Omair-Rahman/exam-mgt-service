        ...
        <div class="col-12">
            <div class="card" style="padding: 0px 10px;">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">SubCategory Information</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @foreach ($categories as $category)
                                @foreach ($category->subcategories as $subcategory)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('subcategories.edit', $subcategory->id) }}" class="btn btn-outline-secondary butsty">
                                                <span class="mdi mdi-file-document-edit-outline iconsty"></span>
                                            </a>
                                            <form id="delete-form-subcategory-{{ $subcategory->id }}"action="{{ route('subcategories.destroy',$subcategory->id) }}"method="POST" class="d-inline">
                                                @csrf @method('DELETE')
                                                <button type="button"
                                                        class="btn btn-outline-danger btn-delete butsty"
                                                        data-target-form="delete-form-subcategory-{{ $subcategory->id }}">
